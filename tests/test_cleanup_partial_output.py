...
class TestCleanupPartialOutputFullCleanup:
    ...
    async def test_full_cleanup_removes_all_files(self, test_storage: dict, video_slug: str, output_dir: Path):
        ...
        # Patch config to use test storage
        import worker.transcoder
        original_videos_dir = worker.transcoder.VIDEOS_DIR
        worker.transcoder.VIDEOS_DIR = test_storage["videos"]
        ...
        try:
            ...
            worker.transcoder.VIDEOS_DIR = original_videos_dir

    async def test_full_cleanup_when_completed_names_is_none(self, test_storage: dict, video_slug: str, output_dir: Path):
    ...
    async def test_cleanup_nonexistent_directory(self, test_storage: dict):
...
class TestCleanupPartialOutputSelectiveCleanup:
    ...
    async def test_selective_cleanup_keeps_completed_qualities(self, test_storage: dict, video_slug: str, output_dir: Path):
    ...
    async def test_selective_cleanup_removes_incomplete_qualities(self, test_storage: dict, video_slug: str, output_dir: Path):
    ...
    async def test_master_playlist_always_removed(self, test_storage: dict, video_slug: str, output_dir: Path):
...
class TestDynamicQualityPatternMatching:
    ...
    async def test_matches_all_standard_qualities(self, test_storage: dict, video_slug: str, output_dir: Path):
    ...
    async def test_matches_original_quality(self, test_storage: dict, video_slug: str, output_dir: Path):
    ...
    async def test_ignores_non_quality_files(self, test_storage: dict, video_slug: str, output_dir: Path):
    ...
    async def test_handles_segment_files_with_various_numbers(self, test_storage: dict, video_slug: str, output_dir: Path):
